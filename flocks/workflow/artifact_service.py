...
from flocks.workflow.fs_store import find_workspace_root, read_workflow_dir, workflow_scan_dirs
from flocks.workflow.models import Workflow
from flocks.workflow.node_type_spec import NODE_TYPE_SPECS
...
def workflow_dir(workflow_id: str, *, workspace: Optional[Path] = None) -> Path:
    ...
    return root / ".flocks" / "plugins" / "workflows" / workflow_id
