...
See ``smartclaw.tool.tool_loader._build_script_handler`` for the implementation.
"""
...
from smartclaw.tool.tool_loader import _build_script_handler
...
def _write_script(tmp_path: Path, source: str) -> Path:
    plugins_root = tmp_path / ".smartclaw" / "plugins" / "tools" / "api" / "demo"
