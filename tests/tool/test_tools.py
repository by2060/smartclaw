...
def temp_dir():
    ...
    temp_path = tempfile.mkdtemp(prefix="smartclaw_test_")
    yield temp_path
    # Cleanup after tests
...
class TestToolRegistry:
    ...
    def test_registry_initialization(self):
        ...
        # Registry should be initialized when smartclaw.tool is imported
...
class TestQuestionTool:
    ...
    async def test_question_tool_output_defaults_to_english(self, tool_context, monkeypatch):
        ...
        from smartclaw.tool.system import question as question_module
    ...
    async def test_question_tool_output_uses_chinese_locale(self, tool_context, monkeypatch):
        ...
        monkeypatch.setenv("SMARTCLAW_SESSION_PROMPT_LOCALE", "zh-CN")
        monkeypatch.setattr(question_module, "_question_handler", handler)
