...
def test_bootstrap_bash_install_help_mentions_current_directory_default() -> None:
    ...
    assert str(install_cwd / "smartclaw") in output
...
def test_bootstrap_bash_install_zh_help_mentions_gitee_raw_and_current_directory_default() -> None:
    ...
    assert "https://gitee.com/smartclaw/smartclaw/raw/main/install_zh.sh" in output
...
def test_bootstrap_powershell_install_zh_help_mentions_gitee_raw_and_current_directory_default() -> None:
    ...
    assert "https://gitee.com/smartclaw/smartclaw/raw/main/install_zh.ps1" in output
...
if ($system32Default.Replace('/', '\\') -ne 'C:\\Users\\tester\\smartclaw') {
...
if ($workspaceDefault.Replace('/', '\\') -ne 'D:\\workspace\\smartclaw') {
