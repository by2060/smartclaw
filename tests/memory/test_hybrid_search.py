...
async def test_hybrid_search():
    ...
    print("\n[1/5] Testing imports...")
    try:
        from smartclaw.memory.search import HybridSearch
        from smartclaw.memory.search.hybrid import decorate_citations, format_citation
        from smartclaw.memory import MemoryQueryConfig, MemorySearchResult, MemorySource
