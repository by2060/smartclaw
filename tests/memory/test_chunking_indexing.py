...
async def test_chunking_and_indexing():
    ...
    print("\n[1/6] Testing imports...")
    try:
        from smartclaw.memory.sync import TextChunker, MemoryIndexer
        from smartclaw.memory import MemoryConfig, MemoryChunkingConfig
    ...
    try:
        from smartclaw.memory.utils import compute_hash
    ...
    try:
        from smartclaw.memory.utils import compute_text_hash
