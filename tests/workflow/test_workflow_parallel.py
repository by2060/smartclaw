...
from smartclaw.tool.registry import ParameterType, ToolCategory, ToolParameter, ToolRegistry, ToolResult
from smartclaw.workflow.engine import ExecutionResult, StepResult, WorkflowEngine
    ...
    def test_parallel_python_nodes_use_shared_tool_loop(self):
        ...
        try:
            ...
            def _spy_run_sync(coro):
                ...
                from smartclaw.workflow._async_runtime import run_sync
            ...
            with patch("smartclaw.workflow.tools_adapter._run_sync_on_shared_loop", side_effect=_spy_run_sync):
...
class TestParallelCancel:
    ...
    def test_cancel_between_batches(self):
        ...
        from smartclaw.workflow.errors import RunCancelledError
