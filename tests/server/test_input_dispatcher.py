...
from smartclaw.command.command import Command, CommandDef
from smartclaw.input.dispatcher import dispatch_user_input, parse_slash_command
from smartclaw.input.events import UserInputEvent
from smartclaw.input.output import CallbackOutputSink
...
class TestSessionRoutesUseDispatcher:
    ...
    async def test_prompt_async_routes_through_dispatcher(self, monkeypatch):
        ...
        monkeypatch.setattr("smartclaw.project.instance.Instance.provide", fake_provide)
        monkeypatch.setattr(
