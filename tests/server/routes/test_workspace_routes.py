...
class TestWorkspaceUpload:
    ...
    async def test_chat_upload_rejects_disallowed_file_type(
        ...
        chat_root = mock_workspace.parent / "home" / ".smartclaw" / "workspace" / "uploads" / "chat" / "ses_chat"
    ...
    async def test_chat_upload_accepts_all_supported_file_types(
        ...
        chat_root = mock_workspace.parent / "home" / ".smartclaw" / "workspace" / "uploads" / "chat" / "ses_supported"
    ...
    async def test_chat_upload_renames_duplicate_file(
        ...
        chat_dir = mock_workspace.parent / "home" / ".smartclaw" / "workspace" / "uploads" / "chat" / "ses_uploads"
    ...
    async def test_chat_upload_returns_error_after_too_many_name_conflicts(
        ...
        uploads_dir = mock_workspace.parent / "home" / ".smartclaw" / "workspace" / "uploads" / "chat" / "ses_conflict"
