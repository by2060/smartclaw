...
from smartclaw.mcp.types import McpStatus, McpStatusInfo
from smartclaw.server.routes import mcp as mcp_routes
...
class TestMcpRoutes:
    ...
    async def test_get_mcp_server_info_masks_plaintext_sensitive_values(
        ...
        assert data["config"]["headers"]["X-Client"] == "smartclaw"
    ...
    async def test_update_mcp_server_restores_masked_sensitive_values(
        ...
        assert stored_configs["demo-mcp"]["headers"]["X-Client"] == "smartclaw-web"
    ...
    async def test_test_credentials_then_connect_is_idempotent(
        ...
        import smartclaw.mcp as mcp_pkg
        from smartclaw.mcp import server as mcp_server
