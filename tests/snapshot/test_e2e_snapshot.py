...
from smartclaw.snapshot import Snapshot, SnapshotPatch
from smartclaw.session import Session, SessionRevertManager, RevertInput
...
class TestE2ESnapshotWorkflow:
    ...
    def setup_method(self):
        ...
        self.test_dir = tempfile.mkdtemp(prefix="smartclaw_e2e_test_")
...
class TestE2ESessionRevert:
    ...
    def setup_method(self):
        """Set up test environment"""
        self.test_dir = tempfile.mkdtemp(prefix="smartclaw_e2e_session_test_")
...
class TestCLISnapshotCommands:
    ...
    def setup_method(self):
        """Set up test environment"""
        self.test_dir = tempfile.mkdtemp(prefix="smartclaw_cli_test_")
