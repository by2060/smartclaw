...
from smartclaw.utils.log import Log, Logger, LogLevel
...
class TestLogInitialization:
    ...
    async def test_init_creates_log_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                log_dir = Path(tmpdir) / ".smartclaw" / "logs"
    ...
    async def test_log_file_path(self):
        ...
        file_path = Log.file()
        assert file_path.endswith("smartclaw.log") or "smartclaw" in file_path
