...
def test_parse_product_use_project_skill_files() -> None:
    skill_files = [
        PROJECT_ROOT / ".smartclaw" / "plugins" / "skills" / "tdp-use" / "SKILL.md",
        PROJECT_ROOT / ".smartclaw" / "plugins" / "skills" / "onesec-use" / "SKILL.md",
        PROJECT_ROOT / ".smartclaw" / "plugins" / "skills" / "qingteng-use" / "SKILL.md",
        PROJECT_ROOT / ".smartclaw" / "plugins" / "skills" / "skyeye-use" / "SKILL.md",
    ]
