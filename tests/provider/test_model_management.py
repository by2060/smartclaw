...
class TestCredentialUtils:
    ...
    def test_has_credential_false_when_no_secrets(self):
        ...
        from smartclaw.provider.credential import has_credential
    ...
    def test_list_configured_providers_empty(self):
        ...
        from smartclaw.provider.credential import list_configured_providers
...
class TestBaseProviderExtensions:
    ...
    def test_get_meta_default(self):
        from smartclaw.provider.provider import BaseProvider
    ...
    def test_get_model_definitions_from_legacy(self):
        from smartclaw.provider.provider import BaseProvider, ModelInfo, ModelCapabilities
