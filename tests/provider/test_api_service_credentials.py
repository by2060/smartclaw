...
class TestAPIServiceCredentials:
    ...
    async def test_get_service_credentials_returns_base_url_and_username(self):
        from smartclaw.server.routes.provider import get_service_credentials
    ...
    async def test_set_service_credentials_persists_api_key_base_url_and_username(self):
        from smartclaw.server.routes.provider import ProviderCredentialRequest, set_service_credentials
        ...
        with (
            ...
            patch("smartclaw.config.config_writer.ConfigWriter.set_api_service") as mock_set_api_service,
        ):
    ...
    async def test_get_service_credentials_returns_dynamic_qingteng_fields(self):
        ...
        with (
            ...
            patch("smartclaw.server.routes.provider._load_api_service_metadata_data", return_value=metadata),
        ):
