...
from smartclaw.provider.sdk.openai_base import OpenAIBaseProvider, extract_reasoning_content
from smartclaw.provider.provider import ModelInfo, ModelCapabilities, ProviderConfig
...
class TestOpenAIBaseProviderGetModels:
    ...
    def test_get_models_catalog_import_error(self):
        ...
        with patch('smartclaw.provider.model_catalog.get_provider_model_definitions') as mock_get_defs:
    ...
    def test_get_models_with_config_models(self):
        ...
        from smartclaw.provider.provider import ModelInfo, ModelCapabilities
        provider._config_models = [
            ModelInfo(
                id="custom-model-1",
                name="Custom Model 1",
