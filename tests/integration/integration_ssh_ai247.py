...
class TestLiveSSHExecution:
    ...
    def _import_tool(self):
        ...
        import smartclaw.tool.security.ssh_host_cmd  # noqa: F401
...
TRIAGE_SCRIPT_PATH = ".smartclaw/plugins/agents/host-forensics/scripts/triage.sh"
...
class TestLiveTriageExecution:
    ...
    def _import_tools(self):
        import smartclaw.tool.security.ssh_host_cmd   # noqa: F401
        import smartclaw.tool.security.ssh_run_script  # noqa: F401
    ...
    def test_triage_audit_log(self):
        ...
        from smartclaw.tool.security.ssh_utils import AUDIT_LOG_PATH
        before_size = AUDIT_LOG_PATH.stat().st_size if AUDIT_LOG_PATH.exists() else 0
        self._run_triage()
