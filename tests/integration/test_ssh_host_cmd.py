...
from smartclaw.tool.security.ssh_host_cmd import (
    SafetyDecision,
    classify_command,
    _split_pipeline,
    _get_base_command,
...
from smartclaw.tool.security.ssh_utils import audit_log, AUDIT_LOG_PATH
...
class TestAuditLogger:
    def test_audit_log_creates_file(self, tmp_path):
        ...
        with patch("smartclaw.tool.security.ssh_utils.AUDIT_LOG_PATH", log_path):
            audit_log(
...
class TestUserAllowlist:
    def test_save_and_load(self, tmp_path):
        ...
        with patch("smartclaw.tool.security.ssh_host_cmd.USER_ALLOWLIST_PATH", allowlist_path):
    ...
    def test_load_missing_file_returns_empty(self, tmp_path):
        ...
        with patch("smartclaw.tool.security.ssh_host_cmd.USER_ALLOWLIST_PATH", missing_path):
