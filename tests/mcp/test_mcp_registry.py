...
class TestMcpToolRegistry:
    ...
    def test_track_tool(self):
        ...
        McpToolRegistry.track(
            ...
            smartclaw_tool_name="test_server_test_tool",
            schema_hash="hash123"
        )
        ...
        assert source.smartclaw_tool == "test_server_test_tool"
    ...
    def test_get_server_tools(self):
        ...
        McpToolRegistry.track(
            server_name="server1",
            mcp_tool_name="tool1",
            smartclaw_tool_name="server1_tool1"
        )
        McpToolRegistry.track(
            server_name="server1",
            mcp_tool_name="tool2",
            smartclaw_tool_name="server1_tool2"
        )
        McpToolRegistry.track(
            server_name="server2",
            mcp_tool_name="tool3",
            smartclaw_tool_name="server2_tool3"
        )
    ...
    def test_get_all_servers(self):
        ...
        McpToolRegistry.track(
            server_name="server2",
            mcp_tool_name="tool2",
            smartclaw_tool_name="server2_tool2"
        )
