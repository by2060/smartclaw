...
import smartclaw.mcp.client as mcp_client_module
from smartclaw.mcp.client import McpClient, _extract_root_cause
...
class TestMcpClientRemoteFallback:
    ...
    async def test_remote_injects_oauth2_client_credentials_header(self, monkeypatch: pytest.MonkeyPatch):
        ...
        with patch(
            "smartclaw.mcp.client.McpOAuth2ClientCredentials.get_access_token",
