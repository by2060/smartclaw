...
from smartclaw.mcp.catalog import (
...
from smartclaw.mcp.installer import managed_python_bin_dir, managed_python_executable
...
def _reset_catalog(tmp_path, monkeypatch):
    ...
    repo_example = Path(__file__).resolve().parents[2] / ".smartclaw" / "mcp_list.json.example"
