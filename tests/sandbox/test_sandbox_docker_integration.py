...
from smartclaw.sandbox.docker import docker_container_state, exec_docker, remove_container
...
async def test_real_docker_sandbox_bash_execution() -> None:
    ...
    with tempfile.TemporaryDirectory() as workspace_dir:
        ...
        try:
            ...
            cmd = (
                "echo SMARTCLAW_DOCKER_SANDBOX_OK && "
            ...
            assert "SMARTCLAW_DOCKER_SANDBOX_OK" in output
