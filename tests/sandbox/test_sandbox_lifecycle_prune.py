...
from smartclaw.sandbox.types import SandboxConfig, SandboxPruneConfig
from smartclaw.sandbox.shared import resolve_sandbox_scope_key, slugify_session_key
...
async def test_ensure_sandbox_container_recreates_on_cold_hash_mismatch(
    ...
    from smartclaw.sandbox import docker as mod
...
async def test_maybe_prune_sandboxes_throttles_calls(
    ...
    from smartclaw.sandbox import prune as mod
...
async def test_ensure_docker_image_pulls_default_when_missing(
    ...
    from smartclaw.sandbox import docker as mod
    from smartclaw.sandbox.defaults import DEFAULT_SANDBOX_IMAGE
