...
async def test_run_compaction_restores_idle_status_by_default():
    ...
    with patch(
        "smartclaw.session.lifecycle.compaction.orchestrator.Provider.resolve_model_info",
        return_value=(200_000, 8_192, None),
    ), patch(
        "smartclaw.session.lifecycle.compaction.orchestrator.SessionCompaction.process",
