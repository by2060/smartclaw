"""
Tests for smartclaw/session/core/session_state.py
...
from smartclaw.session.core import session_state as ss
...
class TestSessionAgent:
    ...
    def test_set_and_get(self):
        ss.set_session_agent("ses_1", "titan")
        assert ss.get_session_agent("ses_1") == "titan"

    def test_multiple_sessions_independent(self):
        ss.set_session_agent("ses_a", "titan")
        ss.set_session_agent("ses_b", "plan")
        assert ss.get_session_agent("ses_a") == "titan"
