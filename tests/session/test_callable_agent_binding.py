...
async def test_callable_tools_reinitialize_when_agent_changes(tmp_path):
    ...
    from smartclaw.session.callable_state import get_session_callable_agent, get_session_callable_tools
    ...
    try:
        await Storage.init(tmp_path / "smartclaw.db")
        ...
        from smartclaw.session import callable_state
