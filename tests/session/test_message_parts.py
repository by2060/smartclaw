"""
Tests for message Part types in smartclaw/session/message.py
...
class TestMessageStoreAndParts:
    ...
    async def test_store_part_debounces_non_terminal_tool_state(self, monkeypatch):
        ...
        monkeypatch.setattr("smartclaw.session.message.Recorder.record_tool_state", AsyncMock())
