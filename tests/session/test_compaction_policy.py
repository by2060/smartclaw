...
from smartclaw.session.lifecycle.compaction import CompactionPolicy, ContextTier, _BOUNDS, _MIN_OVERFLOW_THRESHOLD
...
class TestCompactionConfigOverrides:
    ...
    def test_default_empty(self):
        from smartclaw.memory.config import CompactionConfig
