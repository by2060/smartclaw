...
const ONBOARDING_DISMISSED_KEY = 'smartclaw_onboarding_dismissed';

const TBCLOUD_LINKS = {
  cn: 'https://x.threatbook.com/smartclaw/activate',
  global: 'https://i.threatbook.io/smartclaw/activate',
};
