...
const entityTranslations: Record<string, string> = {
  ...
  'entity.tabTest': '测试',
  'entity.titanThinking': 'Agent 正在思考中...',
  'entity.editAndSend': '编辑下方内容，发送给 Agent 查看效果',
  'entity.reTest': '重新测试',
  'entity.testInputPlaceholder': '输入测试内容',
  'entity.startingTitan': '正在启动 Titan 对话...',
  'entity.titanRetry': '重试',
  'entity.titanInputPlaceholder': '描述你想要的配置...',
  'entity.titanReady': 'Titan 准备就绪，请描述你的需求...',
  'entity.testButton': '测试',
  'entity.cancelButton': '取消',
  'entity.extracting': '提取中...',
  'entity.extractFromTitan': '从 Titan 提取配置',
  'entity.switchToForm': '切换到表单',
  'entity.testStartFailed': '测试启动失败',
  'entity.extractFailed': '提取失败，请重试',
  'entity.titanAssist': 'Titan 协助',
};
...
describe('EntitySheet', () => {
  const defaultProps = {
    ...
    entityType: 'Agent',
    titanSystemContext: 'You are an agent creator.',
    titanWelcomeMessage: 'Tell me about the agent you want to create.',
    onClose: vi.fn(),
    onSubmit: vi.fn(),
  ...
  describe('Tab navigation', () => {
    it('should default to Titan tab in create mode', () => {
      render(
