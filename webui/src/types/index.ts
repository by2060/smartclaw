// Common types for the SmartClaw WebUI
...
export interface Tool {
  ...
  /** True when a user setting is recorded in smartclaw.json `tool_settings`. */
...
/** Provider info from backend (SmartClaw-compatible format) */
