    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-2 py-2">
        {filteredSkills.length === 0 ? (
          ...
          <>
            {/* 用户自定义技能（source: user | smartclaw | claude | 其他） */}
            {userSkills.length > 0 && (
              <div className="mb-5">
            ...
            {/* 内置技能（source: project，即项目 .smartclaw/plugins 目录） */}
...
/** Custom skills: everything except project-installed (.smartclaw/plugins) built-in skills. */
