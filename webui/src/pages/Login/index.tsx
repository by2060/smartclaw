      ...
      >
        ...
        <div className="space-y-2 text-xs text-gray-500 border-t border-gray-100 pt-3">
          <div>
            ...
            {' '}
            <code className="rounded bg-gray-100 px-1.5 py-0.5 text-gray-700">smartclaw admin list-users</code>
          </div>
          <div>
            {t('login.recoverPassword')}
            {' '}
            <code className="rounded bg-gray-100 px-1.5 py-0.5 text-gray-700">smartclaw admin generate-one-time-password --username admin</code>
          </div>
        </div>
      </form>
    </AuthLayout>
