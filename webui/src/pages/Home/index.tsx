...
const GITHUB_URL = 'https://github.com/AgentSmartClaw/smartclaw';
const GITEE_URL = 'https://gitee.com/smartclaw/smartclaw';
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          <div className="flex-1 min-w-0">
            ...
            <h1 className="text-4xl lg:text-5xl font-extrabold mb-3 tracking-tight">
              <span className="text-red-500">SmartClaw</span>
            </h1>
          ...
          {!homePromptsDisabled && (
            <div className="flex flex-wrap sm:flex-nowrap gap-3 sm:flex-shrink-0">
              <button
                onClick={() => window.dispatchEvent(new Event('smartclaw:open-onboarding'))}
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-sm text-red-600 ml-2">Please ensure the SmartClaw backend is running</span>
              </div>
            </div>
          )}
