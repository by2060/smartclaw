...
Provides SQLite-based storage similar to SmartClaw's Storage namespace
"""
...
class Storage:
    ...
    Similar to SmartClaw's Storage namespace.
    ...
    async def init(cls, db_path: Optional[Path] = None) -> None:
        ...
        try:
            from smartclaw.storage.vector import ensure_vector_tables
    ...
    async def _create_model_management_tables(cls) -> None:
        ...
        is stored in smartclaw.json / .secret.json.
        """
