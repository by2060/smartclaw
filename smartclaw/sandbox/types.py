...
使用 Pydantic BaseModel 与 smartclaw 现有配置风格保持一致。
"""
import os
...
class SandboxConfig(BaseModel):
    ...
    workspace_root: Optional[str] = Field(
        default=None,
        description="沙箱工作区根目录 (默认 ~/.smartclaw/sandboxes)",
    )
...
class SandboxContext(BaseModel):
    ...
    project_plugins_dir: Optional[str] = Field(
        default=None,
        description="Project-level SmartClaw plugins directory on the host",
    )
