...
async def build_sandbox_system_prompt(
    ...
    lines = [
        ...
        "- generated reports and final outputs should be written under $SMARTCLAW_OUTPUTS_DIR.",
        "- workflow intermediate artifacts should be written under $SMARTCLAW_ARTIFACTS_DIR.",
        f"- generated SmartClaw plugins must be written under {sandbox_ctx.container_workdir}/.smartclaw/plugins/.",
