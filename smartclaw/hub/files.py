...
from smartclaw.hub.models import HubFileContent, HubFileNode, PluginType
from smartclaw.hub.paths import get_bundled_hub_root, safe_relative_path
...
def plugin_root(plugin_type: PluginType, plugin_id: str) -> Path:
    from smartclaw.hub.catalog import manifest_path, system_plugin_root
