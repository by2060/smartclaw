...
Defines event types for streaming LLM responses, matching SmartClaw' event system.
Based on SmartClaw' ported src/session/processor.ts event handling.
"""
...
# Event type literals matching SmartClaw
