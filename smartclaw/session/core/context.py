...
from smartclaw.session.message import MessageInfo, MessageRole, ToolPart
...
class DefaultSessionContext:
    ...
    async def update_status(self, status_type: str, **kwargs: Any) -> None:
        from smartclaw.session.core.status import (
            SessionStatus,
            SessionStatusBusy,
            SessionStatusIdle,
            SessionStatusRetry,
    ...
    async def request_compaction(self) -> bool:
        from smartclaw.session.lifecycle.compaction import SessionCompaction
        from smartclaw.session.lifecycle.compaction.policy import CompactionPolicy
        from smartclaw.session.message import Message
