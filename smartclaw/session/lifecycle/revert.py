...
Based on SmartClaw' ported src/session/revert.ts
"""
...
from smartclaw.session.session import Session, SessionInfo, SessionRevert as SessionRevertModel
from smartclaw.session.message import Message, MessageInfo
...
class SessionRevert:
    """
    Session revert namespace (SmartClaw compatible alias)
