...
PDF_VISION_DEFAULT_MAX_SCAN_PAGES = 100
...
@ToolRegistry.register_function(
    ...
    description=(
        ...
        "is written to the SmartClaw workspace outputs directory for today."
    ),
    description_cn=(
        "将 PDF、Office 或 HTML 文档解析为 Markdown，并写入 .md 文件。"
        "如果省略 output_path，Markdown 文件会写入今天的 SmartClaw workspace outputs 目录。"
    ),
    ...
    parameters=[
        ...
        ToolParameter(
            ...
            description=(
                ...
                "Relative paths are resolved inside the SmartClaw workspace directory."
            ),
            required=False,
        ),
        ToolParameter(
