"""
SmartClaw Tool System

Provides a comprehensive tool system compatible with SmartClaw's TypeScript implementation.
...
Usage:
    from smartclaw.tool import ToolRegistry, ToolContext, ToolResult
