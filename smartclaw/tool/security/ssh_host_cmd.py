...
All commands are audit-logged to ~/.smartclaw/audit/ssh_commands.log.
Users can permanently whitelist commands via ~/.smartclaw/ssh_allowed_commands.json.
"""
...
from smartclaw.tool.security.ssh_utils import (
    audit_log,
    execute_ssh_command,
...
USER_ALLOWLIST_PATH = Path.home() / ".smartclaw" / "ssh_allowed_commands.json"
