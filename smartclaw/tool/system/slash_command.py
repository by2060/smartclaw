...
inspect or control the SmartClaw runtime from within a conversation.
"""
...
async def run_slash_command_tool(ctx: ToolContext, command: str) -> ToolResult:
    ...
    if command == "workflows":
        ...
        effective_agent = str(ctx.agent or "titan").strip() or "titan"
        ...
        if not entries:
            return ToolResult(success=True, output="No workflows found in .smartclaw/plugins/workflows/ directories.")
