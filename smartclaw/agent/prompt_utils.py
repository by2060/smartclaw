...
by Titan, Hephaestus, and similar orchestrator agents.  Each function takes typed
context objects from :mod:`smartclaw.agent.agent` and returns a Markdown string.

Previously located at smartclaw.agent.prompts.builder.dynamic.
"""
