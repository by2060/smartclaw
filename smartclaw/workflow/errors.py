...
class SmartClawWorkflowError(Exception):
    """Base exception for this project."""


class WorkflowValidationError(SmartClawWorkflowError):
    """Raised when a workflow JSON or graph is invalid."""


class NodeExecutionError(SmartClawWorkflowError):
...
class MaxStepsExceededError(SmartClawWorkflowError):
...
class RunCancelledError(SmartClawWorkflowError):
...
class RunTimeoutError(SmartClawWorkflowError):
...
class NodeTimeoutError(SmartClawWorkflowError):
