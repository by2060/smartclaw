...
This module is intentionally self-contained inside `smartclaw.workflow` (no dependency
on the external `smartclaw-workflow` package).
"""
...
_logger = logging.getLogger("smartclaw.workflow.compiler")
