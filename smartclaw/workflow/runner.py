...
from .errors import SmartClawWorkflowError, RunCancelledError, RunTimeoutError
...
_logger = logging.getLogger("smartclaw.workflow.runner")
...
def _ensure_logging_configured() -> None:
    """确保日志已配置，如果没有则使用默认配置。"""
    workflow_logger = logging.getLogger("smartclaw.workflow")
    # 检查是否已经配置了 handler
...
def run_workflow(
    *,
    ...
    except SmartClawWorkflowError as e:
