...
_WORKFLOW_SITE_PACKAGES = "/workspace/.smartclaw/workflow/site-packages"
...
class PythonExecRuntime(Runtime):
    ...
    tool_registry: Optional[Any] = None  # SmartClawToolAdapter or compatible
...
_extra_site = os.environ.get("SMARTCLAW_WORKSPACE_DIR", "/workspace").rstrip("/") + "/.smartclaw/workflow/site-packages"
