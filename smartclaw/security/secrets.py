...
Stores all secrets in ~/.smartclaw/config/.secret.json as a flat {secret_id: secret_value} dict.
...
class SecretManager:
    ...
    Stores secrets in ~/.smartclaw/config/.secret.json with 600 permissions.
    ...
    def __init__(self, secret_file: Optional[Path] = None):
        ...
        Args:
            secret_file: Path to secret file. Defaults to ~/.smartclaw/config/.secret.json
                         (or the directory specified via SMARTCLAW_CONFIG_DIR).
        """
