...
in .secret.json rather than smartclaw.json. This module handles extracting
...
# Field names considered sensitive — stored in .secret.json, not smartclaw.json
...
def extract_channel_secrets(channels_config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Args:
        channels_config: The ``channels`` section of the smartclaw config dict.
