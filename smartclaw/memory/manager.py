...
from smartclaw.storage import Storage
from smartclaw.utils.file import File
...
from smartclaw.memory.search.hybrid import HybridSearch, decorate_citations
...
class MemoryManager:
    ...
    async def read_file(
        ...
        Uses SmartClaw' File.read() for consistency.
