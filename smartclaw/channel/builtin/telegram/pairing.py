...
the Bot.  The operator enters the code in the SmartClaw UI to add the user to
...
async def send_pairing_code(
    ...
    text = (
        ...
        f"<code>{code}</code>\n\n"
        f"Enter this code in the SmartClaw UI under the Telegram channel settings to complete pairing.\n"
