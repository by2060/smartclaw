...
ChatBot messages are converted into SmartClaw :class:`InboundMessage`
instances and forwarded to the gateway dispatcher.

This module is the inbound counterpart to :mod:`smartclaw.channel.builtin.dingtalk.send`
...
async def _preflight_open_connection(
    *,
    ...
    payload = {
        ...
        "subscriptions": [],
        "ua": "smartclaw-dingtalk-preflight/1.0",
    }
    headers = {
        "Content-Type": "application/json",
        "Accept": "application/json",
        "User-Agent": (
            f"smartclaw-dingtalk-preflight/1.0 "
...
def _resolve_chat_id(message: Any, *, is_group: bool) -> str:
    ...
    :func:`smartclaw.channel.builtin.dingtalk.config.resolve_target_kind`
...
class DingTalkStreamRunner:
    ...
    :meth:`smartclaw.channel.gateway.manager.ChannelGateway._run_with_reconnect`
