...
from smartclaw.channel.base import ChannelPlugin
...
class ChannelRegistry:
    ...
    def _register_builtin_channels(self) -> None:
        from smartclaw.channel.builtin.dingtalk.channel import DingTalkChannel
        ...
        from smartclaw.channel.builtin.wecom.channel import WeComChannel
    ...
    def _load_project_channels() -> None:
        from smartclaw.plugin import PluginLoader, scan_directory
        project_channels_dir = Path.cwd() / ".smartclaw" / "plugins" / "channels"
