...
Started during ``smartclaw serve`` / ``smartclaw tui`` and integrated into
...
from smartclaw.channel.base import ChannelPlugin, ChannelStatus
from smartclaw.channel.inbound.dispatcher import InboundDispatcher
from smartclaw.channel.registry import ChannelRegistry, default_registry
...
class GatewayManager:
    ...
    async def stop_all(self) -> None:
        ...
        try:
            from smartclaw.channel.inbound.session_binding import close_binding_db
    ...
    async def _mark_connected(plugin: ChannelPlugin, channel_id: str) -> None:
        ...
        try:
            from smartclaw.channel.events import ChannelConnected
    ...
    def _record_error(
        ...
        try:
            from smartclaw.channel.events import ChannelDisconnected
            from smartclaw.bus.bus import Bus
