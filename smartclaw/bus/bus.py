...
Based on SmartClaw' ported src/bus/index.ts
"""
...
from smartclaw.bus.bus_event import EventDefinition, BusEvent
...
class Bus:
    ...
    Mirrors original SmartClaw Bus namespace from bus/index.ts
