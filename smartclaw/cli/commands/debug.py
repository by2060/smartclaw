...
Provides debugging utilities for SmartClaw
"""
...
from smartclaw.snapshot import Snapshot

debug_app = typer.Typer(
    name="debug",
    help="Debug utilities for SmartClaw",
...
def info():
    ...
    """
    console.print(Panel("[bold cyan]SmartClaw Debug Information[/bold cyan]"))
