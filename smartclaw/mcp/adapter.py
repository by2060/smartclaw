...
Converts MCP Tools to SmartClaw Tools, implementing protocol adaptation
"""

from concurrent.futures import TimeoutError as FuturesTimeoutError
from typing import Dict, Any

from smartclaw.mcp.types import McpToolDef
from smartclaw.mcp.client import McpClient
from smartclaw.mcp.utils import generate_tool_name, calculate_schema_hash
...
class McpToolAdapter:
    ...
    Responsible for converting MCP Tools to SmartClaw Tools
    """
    ...
    def convert_tool(
        ...
        """
        Convert MCP Tool to SmartClaw Tool
