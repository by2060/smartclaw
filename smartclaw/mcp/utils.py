...
def resolve_url_template(url: str) -> str:
    ...
    in ``smartclaw.json`` while keeping the actual secret value in
    ...
    import re
    from smartclaw.security.secrets import get_secret_manager
...
def resolve_env_var(value: str) -> str:
    ...
    Supported formats:
        ...
        - ``{secret:KEY}``     — read from SecretManager (~/.smartclaw/config/.secret.json)
