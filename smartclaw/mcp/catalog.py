...
from smartclaw.mcp.installer import rewrite_local_command_for_managed_python
...
class CatalogEntry(BaseModel):
    ...
    def to_mcp_config(
        ...
        """Generate MCP server configuration for ~/.smartclaw/config/smartclaw.json.
...
class McpCatalog:
    ...
    def generate_config(
        ...
        Returns:
            Dict suitable for the ``mcp`` key in smartclaw.json.
        """
    ...
    def generate_full_config_template(self) -> Dict[str, Any]:
        ...
        Returns:
            Complete smartclaw.json-compatible configuration.
        """
