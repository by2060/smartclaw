...
from smartclaw.mcp.server import McpServerManager
from smartclaw.mcp.adapter import McpToolAdapter
from smartclaw.mcp.registry import McpToolRegistry
from smartclaw.mcp.catalog import McpCatalog, CatalogEntry, CategoryInfo
from smartclaw.mcp.installer import preflight_install
...
class MCP:
    ...
    @classmethod
    def get_tool_source(cls, smartclaw_tool_name: str) -> Optional[McpToolSource]:
        """
        ...
        """
        return McpToolRegistry.get_source(smartclaw_tool_name)
    ...
    def is_mcp_tool(cls, smartclaw_tool_name: str) -> bool:
        ...
        """
        return McpToolRegistry.is_mcp_tool(smartclaw_tool_name)
