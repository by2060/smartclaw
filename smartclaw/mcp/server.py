...
from smartclaw.mcp.client import McpClient
from smartclaw.mcp.oauth2 import McpOAuth2ClientCredentials
from smartclaw.mcp.types import (
    McpStatus, 
    McpStatusInfo, 
    McpServerInfo,
    McpToolDef,
...
from smartclaw.mcp.adapter import McpToolAdapter
from smartclaw.mcp.registry import McpToolRegistry
...
class McpServerManager:
    ...
    in ~/.smartclaw/config/smartclaw.json. The resolved config is passed directly here.
    """
    ...
    async def _register_tools(
        ...
        for mcp_tool in tools:
            try:
                # Convert to SmartClaw Tool
                smartclaw_tool = McpToolAdapter.convert_tool(
                    server_name, 
                    mcp_tool, 
                    client
                )
                
                # Register to SmartClaw ToolRegistry
                from smartclaw.tool import ToolRegistry
                ToolRegistry.register(smartclaw_tool)
                ...
                McpToolRegistry.track(
                    ...
                    smartclaw_tool_name=smartclaw_tool.info.name,
                ...
                log.debug("mcp.tool_registered", {
                    ...
                    "smartclaw_tool": smartclaw_tool.info.name
                })
