...
default parameters, default models) stored in smartclaw.json via ConfigWriter.

All static configuration is stored in smartclaw.json.
...
class ModelManager:
    ...
    All settings are persisted in smartclaw.json — no SQLite dependency.
    """
    ...
    def list_models(
        ...
        Merges provider-defined models with user settings from smartclaw.json.
        """
    ...
    def get_setting(
        ...
        """Get user settings for a model from smartclaw.json."""
    ...
    def update_setting(
        ...
        """Create or update model settings in smartclaw.json."""
        update: Dict[str, Any] = {}
    ...
    def get_default_model(
        ...
        """Get default model for a given type from smartclaw.json."""
    ...
    def set_default_model(
        ...
        """Set default model for a given type in smartclaw.json."""
    ...
    def get_all_defaults(self) -> List[DefaultModelConfig]:
        """Get all configured default models from smartclaw.json."""
    ...
    def delete_default_model(self, model_type: ModelType) -> bool:
        """Delete default model for a given type from smartclaw.json."""
