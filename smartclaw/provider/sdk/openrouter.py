...
Based on @openrouter/ai-sdk-provider from SmartClaw's bundled providers
...
class OpenRouterProvider(OpenAIBaseProvider):
    ...
    def get_models(self) -> List[ModelInfo]:
        """Return user-configured models from smartclaw.json when available.

        Falls back to a set of popular OpenRouter models so the provider
        works out-of-the-box without any smartclaw.json configuration.
        """
