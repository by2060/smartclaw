...
class GoogleProvider(BaseProvider):
    ...
    def _build_generate_config(
        ...
        :func:`smartclaw.provider.options.build_provider_options` for Gemini 2.5
    ...
    def _convert_tools(self, smartclaw_tools: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """Clean and convert tools for Gemini"""
        if not smartclaw_tools:
            return []
