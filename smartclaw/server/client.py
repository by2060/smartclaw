...
from smartclaw.mcp.server import get_manager
from smartclaw.storage.storage import Storage
from smartclaw.utils.log import Log


log = Log.create(service="smartclaw.client")
...
class SmartClawClient:
    """
    SmartClaw SDK client
    
    Provides an interface similar to the TypeScript SmartClawClient.
    """
    ...
    def __init__(self, base_url: str = "http://127.0.0.1:8000"):
        ...
        Args:
            base_url: Base URL of the SmartClaw server
        """
        self._base_url = base_url
