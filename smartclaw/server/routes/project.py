...
from smartclaw.project.project import Project, ProjectInfo, ProjectIcon
...
async def list_projects():
    ...
    Get a list of projects that have been opened with SmartClaw.
    """
    try:
...
async def get_current_project():
    ...
    Retrieve the currently active project that SmartClaw is working with.
    """
