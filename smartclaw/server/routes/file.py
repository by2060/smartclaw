...
from smartclaw.utils.file import File, FileNode, FileContent, FileInfo
from smartclaw.utils.http_file_read_guard import resolve_path_for_http_file_access
...
async def find_text(pattern: str = Query(..., description="Search pattern")):
    ...
    Only searches within the SmartClaw project root directory.
    """
    try:
        import subprocess
        import os
        ...
        if project_root is None:
            raise HTTPException(status_code=403, detail="No SmartClaw project root found")
