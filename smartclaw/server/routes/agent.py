...
SmartClaw TUI expects Agent format:
{
    "name": string,
    "description"?: string,
...
from smartclaw.agent.agent import AgentInfo as AgentInfoModel, AgentModel as AgentModelConfig
...
class AgentResponse(BaseModel):
    """
    Agent response - SmartClaw TUI compatible format.
