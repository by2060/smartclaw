...
Matches SmartClaw' ported src/server/routes/pty.ts
"""
...
from smartclaw.pty.pty import Pty, PtyInfo, CreateInput, UpdateInput, PtyStatus
...
# Routes - matching SmartClaw' PtyRoutes
