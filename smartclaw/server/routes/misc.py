"""
Miscellaneous routes for SmartClaw TUI compatibility

Provides endpoints that SmartClaw SDK expects but are not core functionality.
...
from smartclaw.provider.provider import Provider, ProviderConfig
from smartclaw.tool.system.skill import get_all_skills, get_skill
...
@router.put(
    "/auth/smartclaw",
    summary="SmartClaw auth",
    description="SmartClaw authentication endpoint"
)
async def smartclaw_auth(request: Request) -> Dict[str, Any]:
    """SmartClaw authentication"""
...
@router.post(
    ...
    description="Dispose SmartClaw instance"
)
