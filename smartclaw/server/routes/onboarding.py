...
from smartclaw.provider.credential import get_api_key as get_llm_provider_api_key
from smartclaw.config.config_writer import ConfigWriter
from smartclaw.provider.provider import Provider
from smartclaw.provider.types import ModelType
from smartclaw.security import get_secret_manager
from smartclaw.server.routes.default_model import (
    SetDefaultModelRequest,
    set_default_model,
)
from smartclaw.server.routes.mcp import (
...
def _llm_provider_has_usable_credentials(provider_id: str) -> bool:
    """Match WebUI credential semantics: secrets + inline smartclaw.json apiKey."""
...
ONBOARDING_REGION_PRESETS: Dict[Region, Dict[str, Any]] = {
    "cn": {
        "activation_url": "https://x.threatbook.com/smartclaw/activate",
    ...
    "global": {
        "activation_url": "https://threatbook.io/smartclaw/activate",
