...
from smartclaw.hub.catalog import category_counts, legacy_removed_plugin_message, list_catalog, load_manifest
from smartclaw.hub.files import file_tree, read_file_content
from smartclaw.hub.installer import install_plugin, uninstall_plugin, update_plugin
from smartclaw.hub.models import (
    HubCatalogEntry,
    HubFileContent,
    HubFileNode,
    HubPluginManifest,
